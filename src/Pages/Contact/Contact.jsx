...
<span className="bg-pink-500 h-[10px] w-[100px]"></span>
        ...
        <div className="my-[50px]  flex md:flex-row flex-col  gap-0">
        <div className="flex flex-col py-[50px] px-[20px] rounded  bg-slate-900 gap-2">
         ...
         <p><a href="tel:+2347084183611" className="flex flex-row items-center gap-3 my-2"><span className=" p-2 rounded-full text-slate-50 font-bold"><BiPhoneCall className="text-[30px]  "/></span> <span className="text-slate-300 font-bold text-[17px] ">+234 708 4183 611</span></a></p>
         <p><a href="mailto:nzubestdesmond@gmail.com" className="flex flex-row items-center gap-3 my-2"><span className=" p-2 rounded-full font-bold"><HiOutlineMail className="text-[25px] text-slate-50  "/></span> <span className="text-slate-300 font-bold text-[15px] ">Info@lorddube.com</span></a></p>
         <p><a href="mailto:nzubestdesmond@gmail.com" className="flex flex-row items-center gap-3 my-2"><span className=" p-2 rounded-full font-bold"><BsWhatsapp className="text-[25px] text-slate-50  "/></span> <span className="text-slate-300 font-bold text-[15px] ">Whatsapp</span></a></p>
       </div>
