...
<span className="bg-pink-500 h-[10px] w-[100px]"></span>
        ...
        <div data-aos='fade-up' aos-data-duration='2000' className="max-w-[700px] flex flex-col gap-3 ">
            ...
            <Link to='/contact' className="bg-slate-900 w-fit px-5 p-2 text-slate-50 rounded font-myfont shadow-2xl hover:bg-pink-500 text-[20px]">Contact Us</Link>
        </div>
        <div data-aos='fade-up' aos-data-duration='2000' className="max-w-[600px]">
