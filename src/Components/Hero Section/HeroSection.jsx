...
export const HeroSection = () => {
    ...
    return(
      ...
      className={`min-h-[100vh] relative after:left-0 after:right-0 after:absolute after:top-0 after:h-full flex items-center after:w-full after:bg-Icon pt-[50px]  px-[30px] bg-cover z-[1]  `}>
...
<Link className="bg-slate-50 p-2 hover:bg-yellow-500 text-[20px] font-bold text-slate-900 rounded shadow-2xl ">Contact Us</Link> 
