...
export const AboutHome = () => {
    return(
        <div className="bg-gradient-to-b  flex items-center justify-around flex-col md:flex-row px-[30px] py-[50px] lg:min-h-[100vh] from-slate-50 rounded-t-[50px] gap-5 to-slate-50">
        <div className="max-w-[700px] flex flex-col gap-3 ">
            <h1 className="uppercase font-myfont text-[30px] text-slate-900">About Us</h1>
            <p className="text-slate-700 font-fonty  text-[17px] md:text-[18px] ">Welcome to LordDube Logistic Energy.co, your premier destination for high-quality oil and gas tools. With a commitment to excellence and a strong focus on customer satisfaction, we are dedicated to providing you with the tools and equipment you need to thrive in the dynamic energy industry.</p>
            ...
            <Link className="bg-slate-900 w-fit px-5 p-2 text-slate-50 rounded shadow-2xl hover:bg-green-500 text-[20px]">Read More</Link>
        </div>
